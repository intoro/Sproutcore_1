...
SC.ChildArray = SC.Object.extend(SC.Enumerable, SC.Array,
  ...
  toString: function () {
    ...
    return "%@({  propertyName: '%@',  length: %@,  … })".fmt(arguments.callee.base.apply(this,arguments), propertyName, length);
  },
...
SC.ManyArray = SC.Object.extend(SC.Enumerable, SC.Array,
  ...
  toString: function () {
    ...
    return "%@({\n  ids: [%@],\n  length: %@,\n  … })".fmt(arguments.callee.base.apply(this,arguments), readOnlyStoreIds, length);
  },
...
SC.RecordArray = SC.Object.extend(SC.Enumerable, SC.Array,
  ...
  toString: function () {
    ...
    return "%@({\n    query: %@,\n    storeKeys: [%@],\n    length: %@,\n    … }) %@".fmt(arguments.callee.base.apply(this,arguments), query, storeKeys, length, statusString);
  },
